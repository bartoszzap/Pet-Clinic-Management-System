public class Cat extends Pet {
    ...
    // Cat Constructor
    public Cat(String petType, String name, int age, String colour, double weight, String breed, String lastVisit) {
    ...
    // Override speak method to be Cat specific, print out informal information
    @Override
    public String speak() {
        return "Miaow! I am " + this.getName() + ", a " + this.getAge() + " year old " + this.getBreed();
    }

    // Print out the details of the pet to the console
